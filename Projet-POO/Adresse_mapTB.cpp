...
namespace NS_Comp_Mappage {
	...
	void Adresse_mapTB::setId_Adress(int id) { this->id_adress = id; }
	...
	void Adresse_mapTB::setAdress(String^ adress) { this->adress = adress; }
	...
	int Adresse_mapTB::getId_Adress(void) { return this->id_adress; }
